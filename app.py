...
def build_demand_supply_chart(
    ...
    *,
    ...
    fig.update_layout(
        ...
        legend_title_text="Actual supply components",
        margin={"t": 70, "b": 70},
    )
...
with section_d:
    ...
    with chart_left:
        fig_carbon = px.bar(
            ...
            x="Short_Name",
            y=carbon_field,
            color="Carbon_Comparison_Status",
            text_auto=".0f",
            hover_data={
            ...
            labels={
                ...
                "Carbon_Comparison_Status": "Carbon-result status",
            },
    ...
    tradeoff = px.scatter(
        ...
        color="Energy_Supply_Status",
        category_orders={"Energy_Supply_Status": ENERGY_STATUS_ORDER},
        text="Short_Name",
        hover_name="Strategy",
        hover_data={
            reduction_field: ":.0%",
        ...
        labels={
            "Total_Cost_GBP": "Indicative total cost (£)",
            carbon_field: "Carbon (kgCO₂e)",
            "Energy_Supply_Status": "Energy supply status",
        },
    ...
    if not electric_rows.empty:
        ...
        with balance_left:
            ...
            st.plotly_chart(plant_balance, use_container_width=True)
            st.caption(
        ...
        with balance_right:
            ...
            st.plotly_chart(temporary_balance, use_container_width=True)
            st.caption(
        ...
        with support_left:
            electric_downtime = electric_rows[["Short_Name", "Calculated_Downtime_h_per_day"]].copy()
            if electric_downtime["Calculated_Downtime_h_per_day"].max() > 0.001:
                ...
                fig_down.update_layout(showlegend=False)
        ...
        with support_right:
            cobenefit = results[["Short_Name", "Exhaust_NOx_Index", "Exhaust_PM_Index", "Noise_Index"]].melt(
                id_vars="Short_Name",
                var_name="Indicator",
            ...
            st.plotly_chart(fig_cobenefit, use_container_width=True)
            st.caption(
